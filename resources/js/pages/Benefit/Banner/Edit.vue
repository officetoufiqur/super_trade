...
const form = useForm({
    id: props.benefitBanner.id,
    language: props.benefitBanner.language,
    title_eng: props.benefitBanner.title_eng,
    sub_title_eng: props.benefitBanner.sub_title_eng,
    title_fr: props.benefitBanner.title_fr,
    sub_title_fr: props.benefitBanner.sub_title_fr,
    image: props.benefitBanner.image
});


function submit() {
    form.post('/benefit/banner/update/' + props.benefitBanner.id);
}
...
<template>
    ...
    <Head title="Benefit Banner Edit" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="pt-10 lg:px-20 px-5">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-medium mb-4">Benefit Banner Edit</h1>
                <Link :href="'/benefit/banner'"><button
