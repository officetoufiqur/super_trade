...
const form = useForm({
    language: props.navbar.language,
    title_eng: props.navbar.title_eng,
    url: props.navbar.url,
    title_fr: props.navbar.title_fr,
});

const submit = () => {
    form.post('/home/navbar/update/' + props.navbar.id);
};
...
<template>
    ...
    <Head title="Navbar Edit" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="pt-10 lg:px-20 px-5">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-medium mb-4">Navbar Edit</h1>
