...
const form = useForm({
    id: props.joinBanner.id,
    language: props.joinBanner.language,
    title_eng: props.joinBanner.title_eng,
    sub_title_eng: props.joinBanner.sub_title_eng,
    title_fr: props.joinBanner.title_fr,
    sub_title_fr: props.joinBanner.sub_title_fr,
    image: props.joinBanner.image
});


function submit() {
    form.post('/join/now/banner/update/' + props.joinBanner.id);
}
...
<template>
    ...
    <Head title="Join Now Banner Edit" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="pt-10 lg:px-20 px-5">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-medium mb-4">Join Now Banner Edit</h1>
                <Link :href="'/join/now/banner'"><button
