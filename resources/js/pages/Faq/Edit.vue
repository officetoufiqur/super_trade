...
const form = useForm({
    language: props.faq.language,
    question_eng: props.faq.question_eng,
    answer_eng: props.faq.answer_eng,
    question_fr: props.faq.question_fr,
    answer_fr: props.faq.answer_fr,
});

const submit = () => {
    form.post('/faq/update/' + props.faq.id);
};
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="pt-10 lg:px-20 px-5">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-medium mb-4">Faq Edit</h1>
            ...
            <div class="border border-gray-200 p-10 mt-3 shadow rounded">
                <form @submit.prevent="submit">
                    ...
                    <div v-if="form.language === 'english'" class="lg:grid grid-cols-2 mt-5 gap-5">
                        <InputLabel forr="question" :label="'Question English'" v-model="form.question_eng"
                            type="text" :placeholder="'Enter your question english'" />
                        <InputLabel forr="answer" :label="'Answer English'"
                            v-model="form.answer_eng" type="text"
                            :placeholder="'Enter your answer english'" />
                    </div>

                    <div v-if="form.language === 'france'" class="lg:grid grid-cols-2 mt-5 gap-5">
                        <InputLabel forr="question" :label="'Question French'" v-model="form.question_fr"
                            type="text" :placeholder="'Enter your question french'" />
                        <InputLabel forr="answer" :label="'Answer French'"
                            v-model="form.answer_fr" type="text"
