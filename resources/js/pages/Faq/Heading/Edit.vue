...
const form = useForm({
    id: props.faqCardHeading.id,
    language: props.faqCardHeading.language,
    heading_eng: props.faqCardHeading.heading_eng,
    sub_heading_eng: props.faqCardHeading.sub_heading_eng,
    heading_fr: props.faqCardHeading.heading_fr,
    sub_heading_fr: props.faqCardHeading.sub_heading_fr,
});

const submit = () => {
    form.post('/faq/heading/update/' + props.faqCardHeading.id);
};
...
<template>
    ...
    <Head title="Faq Heading Edit" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="pt-10 lg:px-20 px-5">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-medium mb-4">Faq Heading Edit</h1>
                <Link :href="'/faq/heading'"><button
            ...
            <div class="border border-gray-200 p-10 mt-3 shadow rounded">
                <form @submit.prevent="submit">
                    ...
                    <div v-if="form.language === 'english'" class="lg:grid grid-cols-2 mt-5 gap-5">
                        <InputLabel forr="heading_eng" :label="'faq Header English'"
                            v-model="form.heading_eng" type="text" :placeholder="'Enter your header'" />
                        <InputLabel forr="sub_heading_eng" :label="'faq Sub Header English'"
                    ...
                    <div v-if="form.language === 'france'" class="lg:grid grid-cols-2 mt-5 gap-5">
                        <InputLabel forr="heading_fr" :label="'faq Header French'"
                            v-model="form.heading_fr" type="text" :placeholder="'Enter your header'" />
                        <InputLabel forr="sub_heading_fr" :label="'faq Sub Header French'"
