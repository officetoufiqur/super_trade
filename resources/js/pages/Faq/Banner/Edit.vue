...
function submit() {
    form.post('/fqd/banner/update/' + props.benefitBanner.id);
}
...
<template>
    ...
    <Head title="Faq Banner Edit" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="pt-10 lg:px-20 px-5">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-medium mb-4">Faq Banner Edit</h1>
                <Link :href="'/faq/banner'"><button
